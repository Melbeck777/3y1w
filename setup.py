...
cur.execute('create table DURING(DURING_ID integer auto_increment not null, EVENT_ID integer not null, DATE datetime not null, foreign key (EVENT_ID) references EVENT(EVENT_ID), primary key (DURING_ID, EVENT_ID));')
